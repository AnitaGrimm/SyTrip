    ...
    class Importer
    {
        ...
        public void MakeReport(Result Result, Querry Querry, List<ResultItemInfo> infos)
        {
            ...
            foreach(var item in Result.Route)
            {
                ...
                rng.Text += "   " + to.Segment[0].Leg[0].Origin + " " + to.Segment[0].Leg[0].OriginTerminal+ "-" + to.Segment[0].Leg[0].Destination + " " + to.Segment[0].Leg[0].DestinationTerminal + Environment.NewLine;
            ...
            foreach (var item in infos)
            {
                ...
                foreach(var Room in item.SelectedRooms)
                {
                    ...
                    rng.Text += "   " + "Награды: " + Environment.NewLine;
                    foreach (var a in Room.hotel.awards)
                        rng.Text += "       -" + a.provider + ": " + a.rating + Environment.NewLine;
                    i++;
                }
            }
        }
